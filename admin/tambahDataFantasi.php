...
if( tambahDataFantasi($_POST) > 0) {
  echo "
  <script>
  alert(' data buku fantasi berhasil ditambahkan! ');
...
<body>
  ...
  <div class="row">
    ...
    <div class="row">
    <div class="col">
    <img href="https://icons8.com/illustrations/author/zD2oqC8lLBBA" src="../assets/fantasi.png" width="350px">
    </div>
    <div class="col">
